...
class ContactInfo(models.Model):
    mobile_number = models.CharField(max_length=20,validators=[validate_mobileNumber])
    phone_number = models.CharField(max_length=20,validators=[validate_phoneNumber])
